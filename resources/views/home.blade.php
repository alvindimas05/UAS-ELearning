            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="card-body items-center text-center">
                        ...
                        <p class="opacity-70">Learn from industry professionals and academic experts with years of experience</p>
                    </div>
                </div>
                <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="card-body items-center text-center">
                ...
                <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="card-body items-center text-center">
                        ...
                        <p class="opacity-70">Earn recognized certificates to boost your career and showcase your skills</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-xl">The Future of Online Learning in 2026</h3>
                        <p class="opacity-70">Explore the emerging trends and technologies shaping the future of digital education...</p>
                        <div class="flex gap-2 mt-4">
                            <div class="badge badge-outline">Education</div>
                ...
                <article class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-xl">5 Tips for Effective Remote Learning</h3>
                        <p class="opacity-70">Maximize your productivity and success with these proven strategies for online education...</p>
                        <div class="flex gap-2 mt-4">
                            <div class="badge badge-outline">Tips</div>
                            <div class="badge badge-outline">Student Life</div>
                        </div>
                        <div class="card-actions justify-end mt-4">
                            <a href="#" class="link link-primary">Read more →</a>
                        </div>
                ...
                <article class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-xl">How AI is Transforming Education</h3>
                        <p class="opacity-70">Discover how artificial intelligence is revolutionizing personalized learning experiences...</p>
                        <div class="flex gap-2 mt-4">
                            <div class="badge badge-outline">AI</div>
                            <div class="badge badge-outline">Innovation</div>
                        </div>
                        <div class="card-actions justify-end mt-4">
                            <a href="#" class="link link-primary">Read more →</a>
                        </div>
                ...
                <article class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-xl">Career Success Stories from Our Alumni</h3>
                        <p class="opacity-70">Read inspiring stories from students who transformed their careers through online learning...</p>
                        <div class="flex gap-2 mt-4">
                            <div class="badge badge-outline">Success</div>
                            <div class="badge badge-outline">Careers</div>
                        </div>
                        <div class="card-actions justify-end mt-4">
                            <a href="#" class="link link-primary">Read more →</a>
                        </div>
                ...
                <article class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-xl">Building a Strong Learning Community</h3>
                        <p class="opacity-70">Learn how to connect with fellow students and create meaningful learning networks...</p>
                        <div class="flex gap-2 mt-4">
                            <div class="badge badge-outline">Community</div>
                            <div class="badge badge-outline">Networking</div>
                        </div>
                        <div class="card-actions justify-end mt-4">
                            <a href="#" class="link link-primary">Read more →</a>
                        </div>
                ...
                <article class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-xl">New Course Launch: Blockchain Fundamentals</h3>
                        <p class="opacity-70">Dive into the world of blockchain technology and cryptocurrency with our latest course...</p>
                        <div class="flex gap-2 mt-4">
    ...
    <section class="py-20 bg-primary text-primary-content">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <div class="flex gap-4 justify-center flex-wrap">
                ...
                <a href="#contact" class="btn btn-lg btn-outline border-white text-white hover:bg-white hover:text-primary">Contact Us</a>
            </div>
        </div>
    </section>
